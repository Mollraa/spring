...
//		empVO.setLastName("Su");
	...
	public void empSelectOne() {
		EmpVO emoVO = new EmpVO();
		emoVO.setFirstName("steven");
		EmpVO selected = mapper.getEmp(emoVO);
		assertNotNull(selected);
		//INFO : jdbc.sqltiming - SELECT * FROM employees WHERE first_name = 'steven' : 콘솔창에 sql문 확인(and, or 했을 때)
